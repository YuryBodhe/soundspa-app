...
ALTER TABLE "monitoring_current" ADD CONSTRAINT "monitoring_current_tenant_id_tenants_id_fk" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "monitoring_logs" ADD CONSTRAINT "monitoring_logs_tenant_id_tenants_id_fk" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE UNIQUE INDEX "unique_email_tenant" ON "users" USING btree ("email","tenant_id");--> statement-breakpoint
CREATE INDEX "monitoring_logs_tenant_idx" ON "monitoring_logs" USING btree ("tenant_id");--> statement-breakpoint
CREATE INDEX "agent_actions_tenant_idx" ON "agent_actions" USING btree ("tenant_id");--> statement-breakpoint
CREATE INDEX "agent_actions_status_idx" ON "agent_actions" USING btree ("status");